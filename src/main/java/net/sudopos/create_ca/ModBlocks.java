...
import net.sudopos.create_ca.config.CCAStress;
import net.sudopos.create_ca.features.brass_gearbox.BrassGearboxBlock;
import net.sudopos.create_ca.features.inverted.InvertedClutchBlock;
import net.sudopos.create_ca.features.inverted.InvertedGearshiftBlock;
import net.sudopos.create_ca.features.variants.BrassAdjustableChainGearshiftBlock;
import net.sudopos.create_ca.features.variants.BrassBasinBlock;
import net.sudopos.create_ca.features.variants.BrassChainDriveBlock;
