package net.sshmoob.create_ca.ponder;
...
import net.sshmoob.create_ca.ModItems;
...
import static net.sshmoob.create_ca.content.brass_gearbox.BrassGearboxBlock.SHAFT_N;
